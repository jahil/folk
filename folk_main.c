...
#define DEVICE_NAME "folk"	/* Dev name as it appears in /proc/devices   */
...
{
	pr_err("Writing to folk - Folk music isn't supported.\n");
	return -EINVAL;
}
...
static int vintage_init(void)
{
	...
	pr_info("folk - Best Folk Songs from Pakistan - Kernel Module Edition - 2014\n");
	pr_info("Various Artists - Classical Folk Ghazals Tracks\n");
	//pr_info("On the web at http://folk.com\n");
